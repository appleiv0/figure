...
# 허용할 오리진 설정 필요
ALLOWED_ORIGINS = os.environ.get("CORS_ORIGINS", "http://localhost:3001,http://localhost:18500,http://192.168.0.188:18500,http://192.168.0.188:3001,https://family.qlab.ai.kr,https://qlab.ai.kr,https://figuretherapy.ai.kr,http://figuretherapy.ai.kr").split(",")
